...
<body>
    ...
    <!--Fin de header-->
    <main>
        <h1 class="tituloCurso">Curso de vocabulario francés</h1>
        ...
        <section>
            ...
            <div class="preview-curso">
                <video src="https://www.youtube.com/embed/v_zcvFofipg?autoplay=1" width=320 height=240 controls poster="img/logo Ozizi.jpg">
